...
translations_tuple = (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/morph.py:295", "extensions/blender_org/mmd_tools/operators/morph.py:359"), ()),
        ("ja_JP", "まず関連するメッシュを選んでください", (False, ())),
        ("zh_HANS", "请首先选择关联的网格", (False, ())),
    ),
    (
        ("*", "The model mesh can't be found"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:299", "extensions/blender_org/mmd_tools/operators/morph.py:363"), ()),
    ...
    (
        ("Operator", "Convert"),
        (("extensions/blender_org/mmd_tools/panels/prop_camera.py:43", "extensions/blender_org/mmd_tools/panels/prop_lamp.py:35"), ()),
        ("ja_JP", "変換", (False, ())),
        ("zh_HANS", "转换", (False, ())),
    ),
    (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:600", "extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:647"), ()),
        ("ja_JP", "ボーン順序を修正", (False, ())),
        ("zh_HANS", "修复骨骼顺序", (False, ())),
    ),
    (
        ("*", "Total Bones: %d"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:646", "extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:646"), ()),
        ("ja_JP", "ボーン合計: %d", (False, ())),
        ("zh_HANS", "骨骼数量: %d", (False, ())),
    ),
    (
        ("*", "Bone ID is invalid (-1). Please click 'Fix Bone Order' button first to assign proper bone IDs."),
        (("extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:33", "extensions/blender_org/mmd_tools/panels/sidebar/bone_order.py:75"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
