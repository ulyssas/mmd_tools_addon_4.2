...
translation_dict = {
    "ja_JP": {
        ...
        ("*", "Overwrite the bone morphs from active Action Pose before exporting."): "エクスポート前にボーンモーフをアクティブなポーズライブラリから上書きします。",
        ...
        ("Operator", "Overwrite Bone Morphs from active Action Pose"): "ボーンモーフをアクティブなポーズライブラリから上書き",
        ("Operator", "Clean Duplicated Material Morphs"): "重複マテリアルモーフを掃除",
        ...
        ("*", "Toon Tex"): "トゥーンテクスチャ",
        ("*", "Sphere RGB"): "スフィア RGB",
        ("*", "Sphere1 RGB"): "スフィア1 RGB",
        ("*", "Sphere2 RGB"): "スフィア2 RGB",
        ("*", "Sphere A"): "スフィア A",
        ("*", "Sphere1 A"): "スフィア1 A",
        ("*", "Sphere2 A"): "スフィア2 A",
        ("*", "Sphere Tex"): "スフィアテクスチャ",
    ...
    "zh_HANS": {
        ...
        ("*", "Overwrite the bone morphs from active Action Pose before exporting."): "在导出前覆盖活动姿态库中的骨骼变形。",
        ...
        ("Operator", "Overwrite Bone Morphs from active Action Pose"): "覆盖活动姿态库中的骨骼变形",
        ("Operator", "Clean Duplicated Material Morphs"): "清理重复材质变形",
