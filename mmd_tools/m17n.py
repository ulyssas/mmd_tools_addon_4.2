...
translations_tuple = (
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_change_mmd_ik_loop_factor", "extensions/blender_org/mmd_tools/panels/prop_object.py:34", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:167"), ()),
    ...
    (
        ...
        (("bpy.types.MMD_TOOLS_OT_separate_by_materials", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:140"), ()),
    ...
    (
        ("*", "Clean Shape Keys"),
        (("bpy.types.MMD_TOOLS_OT_separate_by_materials.clean_shape_keys", "bpy.types.MMD_TOOLS_OT_separate_by_parts.clean_shape_keys"), ()),
    ...
    (
        ("Operator", "Sep by Parts"),
        (("bpy.types.MMD_TOOLS_OT_separate_by_parts", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:139"), ()),
        ("ja_JP", "部品で分離", (False, ())),
        ("zh_HANS", "按部件分开", (False, ())),
    ),
    (
        ("*", "Separate by loose parts and join by materials.\nThis preserves vertex count."),
        (("bpy.types.MMD_TOOLS_OT_separate_by_parts",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "Toon Texture"),
        (("bpy.types.MMDMaterial.toon_texture", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:149"), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/material.py:266",), ()),
        ("ja_JP", "空のテクスチャノードを  追加しました", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Removed  texture nodes."),
        (("extensions/blender_org/mmd_tools/operators/material.py:314",), ()),
        ("ja_JP", "テクスチャノードを  削除しました", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Select a MMD model"),
        (("extensions/blender_org/mmd_tools/operators/material.py:417", "extensions/blender_org/mmd_tools/operators/misc.py:271", "extensions/blender_org/mmd_tools/operators/misc.py:317"), ()),
        ("ja_JP", "MMDモデルを選択する", (False, ())),
        ("zh_HANS", "选择 MMD 模型", (False, ())),
    ),
    (
        ("*", "Created  toon edge(s)"),
        (("extensions/blender_org/mmd_tools/operators/material.py:428",), ()),
    ...
    (
        ("*", "Materials not found"),
        (("extensions/blender_org/mmd_tools/operators/material.py:365", "extensions/blender_org/mmd_tools/operators/material.py:390"), ()),
        ("ja_JP", "マテリアルが見つかりません", (False, ())),
        ("zh_HANS", "找不到材质", (False, ())),
    ),
    (
        ("*", "This operation will break existing f-curve/action."),
        (("extensions/blender_org/mmd_tools/operators/misc.py:378",), ()),
        ("ja_JP", "この操作は既存のFカーブ/アクションを破壊します", (False, ())),
        ("zh_HANS", "这一操作将破坏现有的函数曲线/动作", (False, ())),
    ),
    (
        ("*", "Click [OK] to run the operation."),
        (("extensions/blender_org/mmd_tools/operators/misc.py:379",), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/misc.py:281",), ()),
        ("ja_JP", "このモデルにはメッシュがありません", (False, ())),
        ("zh_HANS", "该模型不具有任何网格", (False, ())),
    ),
    (
        ("*", "Model Armature not found"),
        (("extensions/blender_org/mmd_tools/operators/misc.py:322",), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/morph.py:1128",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Batch conversion complete: Converted  group morphs."),
        (("extensions/blender_org/mmd_tools/operators/morph.py:1175",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "You need to choose a Related Mesh first"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:296", "extensions/blender_org/mmd_tools/operators/morph.py:360"), ()),
        ("ja_JP", "まず関連するメッシュを選んでください", (False, ())),
        ("zh_HANS", "请首先选择关联的网格", (False, ())),
    ),
    (
        ("*", "The model mesh can't be found"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:300", "extensions/blender_org/mmd_tools/operators/morph.py:364"), ()),
        ("ja_JP", "モデルのメッシュが見つかりません", (False, ())),
        ("zh_HANS", "找不到模型的网格", (False, ())),
    ),
    (
        ("*", 'Material "" not found'),
        (("extensions/blender_org/mmd_tools/operators/morph.py:369",), ()),
        ("ja_JP", 'マテリアル "%s" が見つかりません', (True, ())),
        ("zh_HANS", '找不到材质"%s"', (True, ())),
    ),
    (
        ("*", 'Temporary material "" is in use'),
        (("extensions/blender_org/mmd_tools/operators/morph.py:374",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", '临时材质"%s"已占用', (True, ())),
    ),
    (
        ("*", "No active bone morph"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:798",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "Material not found"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:306",), ()),
        ("ja_JP", "マテリアルが見つかりません", (False, ())),
        ("zh_HANS", "找不到材质", (False, ())),
    ),
    (
        ("*", "Please select a mesh object"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:584",), ()),
        ("ja_JP", "メッシュオブジェクトを選択してください", (False, ())),
        ("zh_HANS", "选择网格物体", (False, ())),
    ),
    (
        ("*", "Invalid uv index: "),
        (("extensions/blender_org/mmd_tools/operators/morph.py:598",), ()),
        ("ja_JP", "無効なUVインデックス: ", (False, ())),
        ("zh_HANS", "无效 UV 索引: ", (False, ())),
    ),
    (
        ("*", "Failed to create a temporary uv layer"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:608",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "无法创建临时 UV 层", (False, ())),
    ),
    (
        ("*", ' * UV map "" not found'),
        (("extensions/blender_org/mmd_tools/operators/morph.py:732",), ()),
        ("ja_JP", ' * UVマップ "%s" が見つかりません', (True, ())),
        ("zh_HANS", ' * 找不到 UV 贴图 "%s"', (True, ())),
    ),
    (
        ("*", "Failed to create morph slider system"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:824",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
        ("*", "Bone morph '' not found in morph sliders"),
        (("extensions/blender_org/mmd_tools/operators/morph.py:833",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/morph.py:327",), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/morph.py:433",), ()),
    ...
    (
        ("Operator", "Select"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/display_panel.py:74", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:203"), ()),
        ("ja_JP", "選択", (False, ())),
        ("zh_HANS", "选择", (False, ())),
    ),
    (
    ...
    (
        ("Operator", "Join"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_production.py:62", "extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:141"), ()),
        ("ja_JP", "統合", (False, ())),
        ("zh_HANS", "合并", (False, ())),
    ),
    (
    ...
    (
        ("*", "Material:"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:145",), ()),
        ("ja_JP", "マテリアル:", (False, ())),
        ("zh_HANS", "材质:", (False, ())),
    ),
    (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:155",), ()),
        ("ja_JP", "Blender用に変換", (False, ())),
        ("zh_HANS", "转换给Blender", (False, ())),
    ),
    (
        ("Operator", "Convert to MMD"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:157",), ()),
        ("ja_JP", "MMD用に変換", (False, ())),
        ("zh_HANS", "转换给MMD", (False, ())),
    ),
    (
        ("Operator", "Setup Textures"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:159",), ()),
        ("ja_JP", "テクスチャ構成", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
    ...
    (
        ("*", "Misc:"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:164",), ()),
        ("ja_JP", "その他:", (False, ())),
        ("zh_HANS", "杂项:", (False, ())),
    ),
    (
        ("Operator", "(Experimental) Global Translation"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:166",), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/panels/sidebar/model_setup.py:152",), ()),
        ("ja_JP", "輪郭プレビュー", (False, ())),
        ("zh_HANS", "边缘预览", (False, ())),
    ),
    (
        ("*", "Material Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:107", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:107"), ()),
        ("ja_JP", "マテリアルオフセット (%d)", (False, ())),
        ("zh_HANS", "材质偏移 (%d)", (False, ())),
    ),
    (
        ("Operator", "View"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:186", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:214"), ()),
        ("ja_JP", "表示", (False, ())),
        ("zh_HANS", "显示", (False, ())),
    ),
    (
    ...
    (
        ("*", "Bone Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:194", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:194"), ()),
        ("ja_JP", "ボーンオフセット (%d)", (False, ())),
        ("zh_HANS", "骨骼偏移 (%d)", (False, ())),
    ),
    (
        ("Operator", "Edit"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:217", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:204"), ()),
        ("ja_JP", "編集", (False, ())),
        ("zh_HANS", "编辑", (False, ())),
    ),
    (
        ("*", "Group Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:238", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:238"), ()),
    ...
    (
        ("*", "UV Offsets (%d)"),
        (("extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:228", "extensions/blender_org/mmd_tools/panels/sidebar/morph_tools.py:228"), ()),
