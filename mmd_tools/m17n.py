...
translations_tuple = (
    (("*", ""),
     ((), ()),
     ("ja_JP", "Project-Id-Version: MMD Tools 4.3.3 (0)\n",
      (False,
       ("Blender's translation file (po format).",
        "Copyright (C) 2024 The Blender Authors.",
        "This file is distributed under the same license as the Blender package.",
        "FIRST AUTHOR <EMAIL@ADDRESS>, YEAR."))),
     ("zh_HANS", "Project-Id-Version: MMD Tools 4.3.3 (0)\n",
      (False,
       ("Blender's translation file (po format).",
        "Copyright (C) 2024 The Blender Authors.",
        "This file is distributed under the same license as the Blender package.",
    ...
    (("*", "Directory path to toon textures. This is normally the \"Data\" directory within of your MikuMikuDance directory"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "卡通纹理路径. 通常是 MikuMikuDance 安装路径下的 Data 目录",
      (False, ())),
     ),
    ...
    (("*", "The collision margin between rigid bodies. If 0, the default value for each shape is adopted."),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "刚体之间的碰撞裕度 若为 0, 则使用每个形状的默认值",
      (False, ())),
     ),
    ...
    (("*", "Disables all the Specular Map textures. It is required for some MME Shaders."),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "禁用所有高光材质 部分 MME 着色器必须禁用高光材质",
      (False, ())),
     ),
    (("*", "Log level"),
    ...
    (("*", "Sort materials for alpha blending. WARNING: Will not work if you have transparent meshes inside the model. E.g. blush meshes"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "将材质排序以用于 Alpha 混合 警告: 若透明材质的网格在同一模型中则无效 例如腮红的网格",
      (False, ())),
     ),
    (("*", "Sort Vertices"),
    ...
    (("*", "Export active rig's Action Pose to VPD file(s) (.vpd)"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "导出活动骨架的动作姿态至 VPD 文件 (.vpd)",
      (False, ())),
     ),
    (("*", "Pose Type"),
    ...
    (("*", "All poses of the rig's Action Pose (the pose name will be the file name)"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "当前骨架动作姿态的所有姿态 (文件名与姿态名相同)",
      (False, ())),
     ),
    ...
    (("*", "Realign bone IDs to be sequential without gaps and apply additional transforms"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "将骨骼 ID 重新对其为连续的序列并应用额外的变换",
      (False, ())),
     ),
    ...
    (("*", "Import VPD file(s) to selected rig's Action Pose (.vpd)"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "向选中骨架的动作姿态导入 VPD 文件 (.vpd)",
      (False, ())),
     ),
    ...
    (("*", "Select mode"),
     (("bpy.types.MMD_TOOLS_OT_sdef_bind.mode",),
      ()),
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "选择模式",
    ...
    (("*", "Set the frame range to best values to play the animation from start to finish. And set the frame rate to 30.0."),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "将帧区间设置为完整播放动画的最优值, 并将帧率设置为 30.0",
      (False, ())),
     ),
    ...
    (("*", "Bone ID for display connection (PMX displayConnection)"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "显示连接 (PMX displayConnection) 使用的骨骼 ID",
      (False, ())),
     ),
    ...
    (("*", "name_e if name_e else name_j"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "name_e if name_e else name_j",
      (False, ())),
     ),
    ...
    (("*", "name_j if name_j else name_e"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "name_j if name_j else name_e",
      (False, ())),
     ),
    (("*", "Operation Target"),
    ...
    (("*", "Successfully migrated  bones from vertex groups to bone_id system"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "成功从旧的顶点组排序迁移至新的骨骼 ID 系统",
      (False, ())),
     ),
    ...
    (("*", "Utility tools for MMD model editing"),
     ...
     ("ja_JP", "",
      (False, ())),
     ("zh_HANS", "MMD 模型编辑实用工具",
      (False, ())),
     ),
    # These strings are somehow missing ...
    (("*", "Model Setup"),
     (),
     ("ja_JP", "", (False, ())),
     ("zh_HANS", "模型设置", (False, ()))
