...
translations_tuple = (
    ...
    (("*", "Directory path to toon textures. This is normally the \"Data\" directory within of your MikuMikuDance directory"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "卡通纹理的路径. 通常为 MikuMikuDance 目录下的\"Data\"目录",
                 (False, ())),
    ),
    (("*", "Branch"),
    ...
    (("*", "Translate appended bones of selected object for Blender"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "将选中物体的附加骨骼转译为适合 Blender 的形式",
                 (False, ())),
    ),
    ...
    (("*", "Calculate the UV offsets of selected vertices and apply to active UV morph"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "计算选中顶点的 UV 偏移并应用至活动的 UV 形变",
                 (False, ())),
    ),
    ...
    (("*", "Finds existing meshes and attaches them to the selected MMD model"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "寻找现存的网格, 并将其附加到选中的 MMD 模型上",
                 (False, ())),
    ),
    ...
    (("*", "Load/Enable MMD fixed axis of selected bones from their Y-axis or the only rotatable axis"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "以Y轴或唯一的可旋转轴为选中的骨骼加载或启用MMD固定坐标轴",
                 (False, ())),
    ),
    ...
    (("*", "Load/Enable MMD local axes of selected bones from their bone axes"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "以骨骼轴为选中的骨骼加载或启用MMD局部坐标轴",
                 (False, ())),
    ),
    ...
    (("*", "The collision margin between rigid bodies. If 0, the default value for each shape is adopted."),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "刚体的碰撞距离. 若设为零，则使用形状的默认值",
                 (False, ())),
    ),
    ...
    (("*", "Multiplier for all bones' IK iterations in Blender"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "Blender 中所有骨骼的逆向运动学迭代数乘数",
                 (False, ())),
    ),
    (("*", "MMD IK Loop Factor"),
    ...
    (("*", "Scaling factor of MMD IK loop"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "MMD 逆运动学循环比例系数",
                 (False, ())),
    ),
    (("Operator", "Check Update"),
     (("bpy.types.MMD_TOOLS_OT_check_addon_update",),
      ()),
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "检查更新",
    ...
    (("*", "Delete shadow bones of selected object and revert bones to default MMD state"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "删除选中物体的影子骨骼并将骨骼复原至默认 MMD 状态",
                 (False, ())),
    ),
    ...
    (("*", "Delete temporary physics objects of selected object and revert physics to default MMD state"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "删除选中物体的临时物理物体并将物理复原为 MMD 默认状态",
                 (False, ())),
    ),
    ...
    (("*", "Remove redundant nodes as well if enabled. Disable it to keep node data."),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "启用时，也清理冗余的节点. 禁用以保留节点数据",
                 (False, ())),
    ),
    (("*", "Subsurface"),
    ...
    (("*", "Convert MMD shader nodes to Principled BSDF as well if enabled"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "启用时，也将MMD着色器节点转换为原理化BSDF",
                 (False, ())),
    ),
    ...
    (("*", "Convert active armature with its meshes to a MMD model (experimental)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "将活动骨架及其网格转换为 MMD 模型 (实验性)",
                 (False, ())),
    ),
    ...
    (("*", "Mirror color (if property \"mirror_color\" is available)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "镜像色 (若\"mirror_color\"属性可用)",
                 (False, ())),
    ),
    ...
    (("*", "MMD toon edge will not be enabled if freestyle line color alpha less than this value"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "若 Freestyle 线条颜色小于此值，则MMD卡通边缘不会启用",
                 (False, ())),
    ),
    ...
    (("*", "Preview toon edge settings of active model using \"Solidify\" modifier"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "预览利用\"实体化\"修改器为活动模型生成的卡通边缘设置",
                 (False, ())),
    ),
    (("*", "Select action"),
    ...
    (("*", "Edit UV morph on a temporary UV layer (use UV Editor to edit the result)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "在临时 UV 图层上编辑 UV 形变 (使用 UV 编辑器来编辑结果)",
                 (False, ())),
    ),
    ...
    (("*", "Export selected MMD model(s) to PMX file(s) (.pmx)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "将选中的 MMD 模型导出至 PMX 文件 (.pmx)",
                 (False, ())),
    ),
    (("*", "Copy textures"),
    ...
    (("*", "Disables all the Specular Map textures. It is required for some MME Shaders."),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "禁用所有高光贴图纹理. 部分 MME 着色器需要启用此项",
                 (False, ())),
    ),
    ...
    (("*", "Sort materials for alpha blending. WARNING: Will not work if you have transparent meshes inside the model. E.g. blush meshes"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "为 Alpha 混合排列材质. 警告：若模型中有透明材质则无法正常工作",
                 (False, ())),
    ),
    (("*", "Sort Vertices"),
    ...
    (("*", "Use custom vertex weight of vertex group \"mmd_vertex_order\""),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "使用\"mmd_vertex_order\"顶点组的自定义顶点权重",
                 (False, ())),
    ),
    ...
    (("*", "Export motion data of active object to a VMD file (.vmd)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "将活动物体的运动数据导出至 VMD 文件 (.vmd)",
                 (False, ())),
    ),
    ...
    (("*", "You can pose the model to export a motion data to different pose base, such as T-Pose or A-Pose"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "可设置模型的姿态以将动作数据导出至不同的基础姿态，如T字姿态或A字姿态",
                 (False, ())),
    ),
    (("Operator", "Export VPD File (.vpd)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "导出 VPD 文件 (.vpd)",
                 (False, ())),
    ),
    (("*", "Export active rig's pose library to VPD file(s) (.vpd)"),
     (("bpy.types.MMD_TOOLS_OT_export_vpd",),
      ()),
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "导出活动骨架的姿态库至 VPD 文件 (.vpd)",
                 (False, ())),
    ),
    (("*", "Pose Type"),
    ...
    (("*", "You can pose the model to export a pose data to different pose base, such as T-Pose or A-Pose"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "可设置模型的姿态以将姿态数据导出至不同的基础姿态，如T字姿态或A字姿态",
                 (False, ())),
    ),
    (("Operator", "Flip Pose"),
    ...
    (("*", "Apply bone's fixed axis to be blender suitable"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "应用骨骼的固定坐标轴，使其适合被 Blender 处理",
                 (False, ())),
    ),
    (("*", "Clean Model"),
    ...
    (("*", "Translate bone names from Japanese to English using selected dictionary"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "使用选中的词典将骨骼名从日语翻译为英语",
                 (False, ())),
    ),
    (("*", "Filepath used for importing the file"),
     (("bpy.types.MMD_TOOLS_OT_import_model.filepath",
       "bpy.types.MMD_TOOLS_OT_import_vmd.filepath",
       "bpy.types.MMD_TOOLS_OT_import_vpd.filepath",
       "bpy.types.MMD_TOOLS_OT_material_open_sphere_texture.filepath",
       "bpy.types.MMD_TOOLS_OT_material_open_texture.filepath"),
      ()),
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "导入文件的路径",
    ...
    (("*", "Fix IK links to be blender suitable"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "修复逆向运动学关联，使其适合被 Blender 处理",
                 (False, ())),
    ),
    (("*", "IK Loop Factor"),
     (("bpy.types.MMD_TOOLS_OT_import_model.ik_loop_factor",),
    ...
    (("*", "Use Blender naming conventions for Left / Right paired bones"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "为左右成对的骨骼应用 Blender 命名约定",
                 (False, ())),
    ),
    ...
    (("*", "Will not use dot, e.g. if renaming bones, will use _R instead of .R"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "不使用点. 例如，重命名骨骼时使用 _R 而非 .R",
                 (False, ())),
    ),
    ...
    (("*", "Rename the bone of motion data to be blender suitable"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "重命名动作数据中的骨骼，使其适于被 Blender 处理",
                 (False, ())),
    ),
    ...
    (("*", "You can pose the model to fit the original pose of a motion data, such as T-Pose or A-Pose"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "可将设置模型的姿态，使其符合动作数据的原始姿态，如T字姿态或A字姿态",
                 (False, ())),
    ),
    (("Operator", "Import VPD File (.vpd)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "导入 VPD 文件 (.vpd)",
                 (False, ())),
    ),
    (("*", "Import VPD file(s) to selected rig's pose library (.vpd)"),
     (("bpy.types.MMD_TOOLS_OT_import_vpd",),
      ()),
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "向选中骨架的姿态库导入 VPD 文件 (.vpd)",
                 (False, ())),
    ),
    (("*", "Rename the bone of pose data to be blender suitable"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "重命名姿态数据中的骨骼，使其适于被 Blender 处理",
                 (False, ())),
    ),
    ...
    (("*", "You can pose the model to fit the original pose of a pose data, such as T-Pose or A-Pose"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "可将设置模型的姿态，使其符合姿态数据的原始姿态，如T字姿态或A字姿态",
                 (False, ())),
    ),
    ...
    (("Operator", "Overwrite Bone Morphs from active Pose Library"),
     (("bpy.types.MMD_TOOLS_OT_morph_overwrite_from_active_pose_library",),
      ()),
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "从活动姿态库覆写骨骼变形",
                 (False, ())),
    ),
    ...
    (("*", "Translate MMD morphs of selected object into format usable by Blender"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "将选中物体的 MMD 变形转译为 Blender 可用的格式",
                 (False, ())),
    ),
    ...
    (("*", "The english name of rigid body ($name_e means use the english name of target bone)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "该刚体的英文名 ($name_e 表示使用目标骨骼的英文名)",
                 (False, ())),
    ),
    (("*", "The name of rigid body ($name_j means use the japanese name of target bone)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "该刚体的名称 ($name_j 表示使用目标骨骼的日文名)",
                 (False, ())),
    ),
    ...
    (("*", "Update rigid body world and references of rigid body constraint according to current scene objects (experimental)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "按照当前场景的物体更新刚体世界以及刚体约束的引用 (实验性)",
                 (False, ())),
    ),
    ...
    (("*", "Reset MMD SDEF cache of selected objects and clean unused cache"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "重设选中物体的 MMD SDEF 缓存并清理未使用的缓存",
                 (False, ())),
    ),
    ...
    (("*", "Set the frame range to best values to play the animation from start to finish. And set the frame rate to 30.0."),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "将帧区间设置为完整播放动画的最优值, 并将帧率设为 30.0",
                 (False, ())),
    ),
    (("Operator", "GLSL View"),
    ...
    (("*", "Add/remove prefix to English name of morph"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "添加或删除变形英文名的前缀",
                 (False, ())),
    ),
    (("Operator", "Update"),
     (("bpy.types.MMD_TOOLS_OT_update_addon",
    ...
    (("*", "MMD IK toggle is used to import/export animation of IK on-off"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "在启用或关闭逆向运动学的情况下导入或导出动画",
                 (False, ())),
    ),
    (("*", "Boolean Definition"),
    ...
    (("*", "Default value for this array"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "该数组的默认值",
                 (False, ("This seems to be a leftover from Blender UI translation.",))),
    ),
    (("*", "Is Array"),
    ...
    (("*", "Shared toon texture id (toon01.bmp ~ toon10.bmp)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "共用卡通纹理的ID (toon01.bmp ~ toon10.bmp)",
                 (False, ())),
    ),
    (("*", "Reflect"),
    ...
    (("*", "Setup drivers for MMD property animation (Visibility and IK toggles)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "为MMD属性动画 (可见性与逆向运动学切换) 设置驱动器",
                 (False, ())),
    ),
    (("*", "Use SDEF"),
    ...
    (("Operator", "MikuMikuDance Model (.pmd, .pmx)"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "MikuMikuDance 模型 (.pmd, .pmx)",
                 (False, ())),
    ),
    ...
    (("*", "Failed to translate %d names, see '%s' in text editor"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "未能翻译 %d 个名称，参见文本编辑器中的 '%s'",
                 (False, ())),
    ),
    ...
    (("*", "No mesh object with \"mmd_bone_order_override\" modifier"),
     ...
     ("ja_JP", "",
               (False, ())),
     ("zh_HANS", "没有带有\"mmd_bone_order_override\"修改器的网格物体",
                 (False, ())),
    ),
    (("*", "Add-on update"),
...
if __name__ == '__main__':
    ...
    for lang, cnt in untranslated_count.items():
      print(f'Of {total_count} entries, {cnt} have not been translated for language {lang}')
