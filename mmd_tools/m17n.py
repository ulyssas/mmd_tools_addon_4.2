...
translations_tuple = (
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/fileio.py:948",), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", '[跳过] 找不到 MMD 模型"%s"的骨架数据', (True, ())),
    ),
    (
        ("*", 'Exported MMD model "" to ""'),
        (("extensions/blender_org/mmd_tools/operators/fileio.py:980",), ()),
    ...
    (
        ("*", "Select a MMD model"),
        (("extensions/blender_org/mmd_tools/operators/material.py:417", "extensions/blender_org/mmd_tools/operators/misc.py:205", "extensions/blender_org/mmd_tools/operators/misc.py:251"), ()),
    ...
    (
        ...
        (("extensions/blender_org/mmd_tools/operators/translations.py:110", "extensions/blender_org/mmd_tools/operators/translations.py:399"), ()),
        ("ja_JP", "名称  の翻訳に失敗しました, テキストエディタで '' を確認してください", (False, ())),
        ("zh_HANS", "未能翻译  个名称，参见文本编辑器中的 ''", (False, ())),
    ),
    (
        ("*", "Root object not found"),
        (("extensions/blender_org/mmd_tools/operators/translations.py:431", "extensions/blender_org/mmd_tools/operators/translations.py:479"), ()),
        ("ja_JP", "", (False, ())),
        ("zh_HANS", "", (False, ())),
    ),
    (
