...
class MMDDisplayItemsPanel(_PanelBase, Panel):
    ...
    def draw(self, context):
        ...
        tb1.operator("mmd_tools.display_item_frame_add", text="", icon="ADD")
        tb1.operator("mmd_tools.display_item_frame_remove", text="", icon="REMOVE")
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator("mmd_tools.display_item_add", text="", icon="ADD")
        tb1.operator("mmd_tools.display_item_remove", text="", icon="REMOVE")
...
class MMDMorphToolsPanel(_PanelBase, Panel):
    ...
    def draw(self, context):
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator("mmd_tools.morph_add", text="", icon="ADD")
        tb1.operator("mmd_tools.morph_remove", text="", icon="REMOVE")
    ...
    def _template_morph_offset_list(self, layout, morph, list_type_name):
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator("mmd_tools.morph_offset_add", text="", icon="ADD")
        tb1.operator("mmd_tools.morph_offset_remove", text="", icon="REMOVE")
...
class MMDRigidbodySelectorPanel(_PanelBase, Panel):
    ...
    def draw(self, context):
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator("mmd_tools.rigid_body_add", text="", icon="ADD")
        tb1.operator("mmd_tools.rigid_body_remove", text="", icon="REMOVE")
